...
export default function Cart() {
  ...
  <div className="max-w-5xl mx-auto px-4 py-10">
    <h1 className="font-serif text-3xl mb-8">
      Shopping Cart{" "}
      <span className="text-lg font-sans font-normal text-gray-400 ml-2">
        ({items.length} items)
      </span>
    </h1>
              ...
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center border border-gray-200 rounded-full">
                  <button
                    ...
                    className="w-8 h-8 flex items-center justify-center hover:bg-gray-50 rounded-full transition-colors text-gray-600"
                  >
                    −
                  </button>
      ...
      <div className="lg:col-span-1">
        <div className="bg-white border border-gray-100 rounded-2xl p-5 sticky top-24">
          ...
          <div className="flex gap-2 mb-5">
            ...
            />
            <button className="bg-gray-100 border border-gray-100 rounded-xl px-4 text-sm font-medium hover:bg-gray-200 transition-colors">
              Apply
            </button>
          </div>

          {/* This is the fixed div: note the closing </div> after shipping */}
          ...
          <Link
            to="/checkout"
            className="btn-sage w-full py-3.5 text-sm font-semibold text-center block"
          >
            🔒 Proceed to Checkout
          </Link>
          ...
          <div className="flex justify-center gap-2 mt-3">
            {["MTN MoMo", "Airtel", "Visa", "Mastercard"].map((m) => (
              <span
                key={m}
                className="text-[9px] bg-gray-50 border border-gray-100 px-1.5 py-1 rounded text-gray-400"
              >
                {m}
              </span>
            ))}
